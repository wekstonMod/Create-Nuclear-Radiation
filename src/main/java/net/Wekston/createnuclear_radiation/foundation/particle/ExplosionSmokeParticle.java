...
public class ExplosionSmokeParticle extends TextureSheetParticle {
    protected ExplosionSmokeParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz, SpriteSet p_106583_) {
        super(level, x, y, z);
        this.xd = vx;
        this.yd = 0;
        this.zd = vz;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType type, @NotNull ClientLevel level, double x, double y, double z, double vx,
                                       double vy, double vz) {
            return new ExplosionSmokeParticle(level, x, y, z, vx,
                    vy, vz, this.sprites);
        }
    }
}
