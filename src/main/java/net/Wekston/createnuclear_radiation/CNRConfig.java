...
{
    public static final CNRConfig.Common COMMON;
    public static final ForgeConfigSpec COMMON_SPEC;

    static {
        final Pair<Common, ForgeConfigSpec> commonSpecPair = new ForgeConfigSpec.Builder().configure(CNRConfig.Common::new);
    ...
    public static class Common {
        ...
        public Common(ForgeConfigSpec.Builder builder) {
            ...
            RadiusDeathGrass = builder.comment("Dead zone radius (set to 0 to remove). RadiusExplodeReactor * RadiusDeathGrass").defineInRange("RadiusDeathGrass", 4, 0, 1024);
