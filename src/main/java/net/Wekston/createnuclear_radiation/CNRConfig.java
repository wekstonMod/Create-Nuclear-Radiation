...
public class CNRConfig
{
    ...
    public static class Common {
        public final ModConfigSpec.IntValue radiusRadiation;
        public final ModConfigSpec.IntValue tickRadioactiveBlock;
        public final ModConfigSpec.IntValue distanceFire;

        public final ModConfigSpec.DoubleValue clearRadiation;
        public final ModConfigSpec.IntValue giveEffectBlidness;
        public final ModConfigSpec.IntValue giveEffectConfusion;
        public final ModConfigSpec.IntValue giveEffectPoison;
        public final ModConfigSpec.IntValue Death;


        public final ModConfigSpec.IntValue RadiusExplodeReactor;
        public final ModConfigSpec.IntValue RadiusBurnt;
        public final ModConfigSpec.IntValue RadiusDeathGrass;
        public final ModConfigSpec.IntValue RadiusDirt;
